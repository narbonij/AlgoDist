...
public class BasicNode extends Node
{
	...
	public void onClock()
	{
		...
		if (!hasMerged && ready && listMerge.size() != 0)
		{
			...
			ready = false;
			// }
		} else if (counterAckFragNeighbors == getNeighbors().size() && counterChildrenOut == children.size())
		{
			counterAckFragNeighbors = 0;
			counterChildrenOut = 0;
			System.out.println(
	...
	public void onMessage(Message m)
	{
		 ...
		 * default: break; }
		 */
		 System.out.println("PHASE:" + phase + "::" + "NODE:" + getID() + " from frag:" + frag + " with father:" + father + " received message:" + m.getFlag() + " from sender:" + m.getSender());
		...
		case "ACK_NEW_ROOT":
			...
			if (out != null)
			{
				...
				if (((Link) m.getContent()).equals(out))
				{
					if (this != out.endpoint(0) && this != out.endpoint(1))
					{
						System.out.println("changing father of:" + getID() + " into:" + outNode);
	...
	private void reset()
	{
		...
		System.out.println("______________END::PHASE: " + phase + " ______________");
	}
